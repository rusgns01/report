...
# 분류 문제에서는 일반적으로 categorical_crossentropy를 사용하는 것이 더 적합.
# 학습 속도나 정확도에 미치는 영향을 실험
...
print('categorical_crossentropy & Adam 정확률=',mlp_adam.evaluate(x_test,y_test,verbose=0)[1]*100)
